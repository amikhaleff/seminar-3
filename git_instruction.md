...
* ### Просмотр списка веток и переключение между ветками

Для вывода списка существующих веток, используем команду :

        git branch

А для переключения между ветками команда **checkout**:
